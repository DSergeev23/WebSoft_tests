...
it('Создание мероприятия', function(){  
    ...
    .type('test_для_действия_смероприятием2')
    cy
...
it('Подача индивидуальной заявки', function(){  
    ...
    .wait(5000)
    cy
    .get('[wt-item-id="1"] > .wt-lp-witemlist-item-wrapper > .wt-lp-witemlist-item-header-wrapper > .wt-lp-witemlist-header')
    .click()
    cy      
...
it('Проверка отображения индивидуальной заявки', function(){  
    ...
    cy
    .contains('test_для_действия_смероприятием2')
    .click()
    cy
...
it ('Отказ от частия в мероприятии', function(){  
    ...
    .click()
    cy
    .contains('Отказаться от участия')
    .click()
    cy
    .contains('Вы отказались от участия в мероприятии')
    .should('be.visible')
    cy
    .contains('OK')
    .click()
